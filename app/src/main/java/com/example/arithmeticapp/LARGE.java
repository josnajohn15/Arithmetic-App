...
public class LARGE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1=(AppCompatButton) findViewById(R.id.l);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (n1 > n2) {
                        Toast.makeText(getApplicationContext(), String.valueOf(n1) + " " + "is largest", Toast.LENGTH_LONG).show();

                    } else {
                        Toast.makeText(getApplicationContext(), String.valueOf(n2) + " " + "is largest", Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e) {
